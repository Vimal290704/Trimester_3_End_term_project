...
![RecipeExplorer Screenshot](D:\WEB_DEV\Trimester_3_End_term_project\RecipeExplorer\src\assets\image.png)
...
mkdir recipe-explorer && cd recipe-explorer
...
The app is configured to be easily deployed to Netlify through their respective platforms. Connect your repository and the deployment process will be handled automatically.
